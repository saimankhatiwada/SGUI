...
{
	m_ShipTexture = SGUI::Texture2D::Create("Assets/Image/Ship.png");
}

void Player::OnUpdate(SGUI::TimeSteps ts)
{
	m_Time += ts;

	if (SGUI::Input::IsKeyPressed(SG_KEY_SPACE))
	{
...
void Player::OnRender()
{
	...
	SGUI::Renderer2D::DrawRotatedQuad({ m_Position.x, m_Position.y, 0.5f }, { 1.0f, 1.3f }, GetRotation(), m_ShipTexture);
}
