...
void Sandbox2D::OnAttach()
{
	...
	m_CheckerboardTexture = SGUI::Texture2D::Create("assets/textures/Checkerboard.png");
}
...
void Sandbox2D::OnUpdate(SGUI::Timestep ts)
{
	SG_PROFILE_FUNCTION();
...

	{
		...
		SGUI::Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.1f }, { 20.0f, 20.0f }, m_CheckerboardTexture, 10.0f);
		SGUI::Renderer2D::DrawRotatedQuad({ -2.0f, 0.0f, 0.0f }, { 1.0f, 1.0f }, rotation, m_CheckerboardTexture, 20.0f);
...
void Sandbox2D::OnEvent(SGUI::Event& e)
{
