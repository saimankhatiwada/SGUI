...
#define SG_PROFILE 0
	...
	#define SG_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::SGUI::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::SGUI::InstrumentationTimer timer##line(fixedName##line.Data)
