...
namespace SGUI
{
	...
	public:
		...
		inline const std::vector<BufferElement>& GetElements() { return m_Element; }
	...
	private:
		void CalculateOffsetAndStride()
		{
			uint32_t offset = 0;
			m_Stride = 0;
			for (std::vector<BufferElement>::iterator::value_type& element : m_Element)//use auto insted od std::vector if needed
			{
